...
public class Spike {
    ...
    public Spike(Context context){
        spike[0] = Bitmap.createScaledBitmap(BitmapFactory.decodeResource(context.getResources(), com.example.moneytrees1.R.drawable.spike0), 207, 210, false);
        spike[1] = Bitmap.createScaledBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.spike1), 207, 210, false);
        spike[2] = Bitmap.createScaledBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.spike2), 207, 210, false);
        random = new Random();
        resetPosition();
    }
